...
const { MAIL_EMAIL, MAIL_PASSWORD, HOST, MAIL_PORT, SECURE, NODE_ENV, RESET_PASSWORD_PAGE } =
    process.env;
...
exports.sendForgotPasswordMail = async ({ name, email, token }) => {
    try {
            ...
            <html lang="en">
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="website">
                            <p>Blogify</p>
                            <p>Craft Your Narrative: Explore, Express, Engage with Blogify!</p>
                        </div>
                    </div>
                </body>
            </html>
        ...
        if (NODE_ENV === "development") console.log(await getTestMessageUrl(information));
        return;
    } catch (error) {
